 ...
 * builds exactly ONE placeholder page (game/_/index.html). Cloudflare
 * Pages' _redirects then proxies every real /game/<id> request to that
 ...
 * in GameClientPage, not from this route's params.
 */
